...
export const Formulario = () => {
    ...
    return (
        <section className="formulario">
            ...
            <CampoTexto obrigatorio="true" label="Nome" placeholder="Digite se nome ..." valor={nome} aoAlterado = {valor => setNome(valor)} />
            <CampoTexto obrigatorio="true" label="Cargo" placeholder="Digite seu cargo" valor={cargo} aoAlterado = {valor => setCargo(valor)} />
            <CampoTexto  label="Imagem" placeholder="Insira sua imagem" valor={imagem} aoAlterado = {valor => setImagem(valor)} />
